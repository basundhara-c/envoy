...
/**
 * Custom address implementation for reverse connection target hosts.
 ...
 * that don't close sockets for reuse in reverse tunnel scenarios.
 */
class ReverseConnTargetHostAddress : public Network::Address::Instance {
public:
  explicit ReverseConnTargetHostAddress(Network::Address::InstanceConstSharedPtr base_address);
